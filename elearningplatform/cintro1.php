    ...
    <body>
        ...
        <div class="w3-sidebar w3-collapse" id="sidenav" style="top: 0px;">
            <div id="leftmenuinner" style="padding-top: 50px;">
                <div id="leftmenuinnerinner" style="background-color:#E7E9EB;">
                    ...
                    <a class="sub" target="_top" href="#">C++ Data Types</a>
                    <br>
                    <h2>C++ Exercises</h2>
        ...
        <div class="content">
            ...
            <div class="nextprev">
                ...
                <a href="csyntax2.php" class="next">Next &raquo;</a>
            </div>
            <br><br>
            <img src="images/c.png" alt="c++" style="height:auto; width:95%">
            <br>
            <hr>
            <div class="data">
                <video src="Videos/Cintro.mp4" type="video/mp4" controls></video>
            </div>
            <hr><hr>
            <h2>What is C++?</h2>
